...
namespace ICMS.Domain.Entites
{
    public class VisitDetails : BaseEntity<int>
    {
        ...
        public byte TetanusDoseNumber { get; private set; }
        ...
        public static VisitDetails Create(int pregnancyDetailsId, DateOnly visitDate, decimal weightInKilo, int pregnancyDurationInWeeks, string bloodPressure, string appInUrineTest, string ogttInUrineTest, string fetalHeartbeat, string fetalMovement, string fetalPosition, string anaemiaOrHemoglobinType, bool legsSwelling = false, bool vaginalBleeding = false, byte tetanusDoseNumber = 0, string? clinicalExaminationAndObservation = null, DateOnly? nextVisitDate = null)
        {
            ...
            return new VisitDetails
            {
                ...
                TetanusDoseNumber = tetanusDoseNumber
            };
        }
