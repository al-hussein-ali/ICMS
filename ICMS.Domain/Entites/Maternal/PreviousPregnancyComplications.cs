...
namespace ICMS.Domain.Entites.Maternal
{
    public class PreviousPregnancyComplications : BaseEntity<int>
    {
        ...
        public static PreviousPregnancyComplications CreateForNewPregnancy(bool vaginalBleedingDuringPregnancy, bool recurrentMiscarriageMoreThanThree, bool diabetes, bool epilepsy, bool heartDisease, bool preeclampsia, bool pretermBirthBefore8Months)
        {
            return new PreviousPregnancyComplications
            {
                VaginalBleedingDuringPregnancy = vaginalBleedingDuringPregnancy,
