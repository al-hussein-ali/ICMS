...
namespace ICMS.Application.Extensions
{
    public static class PersonExtensions
    {
        ...
        public static PersonDetailsDto ToDetailsDto(this Person person)
            => new(person.Id, person.FirstName, person.SecondName, person.ThirdName, person.LastName, person.Gender.ToString(), person.DateOfBirth, person.PhoneNumber, person.CreatedAt, person.User?.Id, person.PregnantWoman?.Id, person.VaccinatedIndividual?.Id);
