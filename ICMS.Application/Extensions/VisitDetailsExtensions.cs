...
namespace ICMS.Application.Extensions
{
    public static class VisitDetailsExtensions
    {
        ...
        public static VisitDetails ToDomain(this VisitDetailsCreateDto dto)
            => VisitDetails.Create(dto.PregnancyDetailsId, dto.VisitDate
                , dto.WeightInKilo, dto.PregnancyDurationInWeeks
                , dto.BloodPressure, dto.APPInUrineTest,
                dto.OGTTInUrineTest, dto.FetalHeartbeat,
                dto.FetalMovement, dto.FetalPosition,
                dto.AnaemiaOrHemoglobinType, dto.LegsSwelling,
                dto.VaginalBleeding, dto.TetanusDoseNumber,
                dto.ClinicalExaminationAndObservation, dto.NextVisitDate); // factory not implemented
    }
}
