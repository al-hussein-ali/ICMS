...
namespace ICMS.Application.Extensions
{
    public static class VaccineExtensions
    {
        public static VaccineReadDto ToReadDto(this Vaccine v)
            => new(v.Id, LocalizationHelper.GetLocalizedValue(v.VaccineName), v.VaccineCode, LocalizationHelper.GetLocalizedValue(v.Description), v.IsActive, v.TotalDosages, v.MinEligibleAgeInMonths, v.MaxEligibleAgeInMonths, v.Audience);
